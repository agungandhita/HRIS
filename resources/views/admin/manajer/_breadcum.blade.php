...
<div id="hs-scale-animation-modal"
    ...
    <div
        ...
        <div class="w-full flex flex-col bg-gray-200 border shadow-sm rounded-xl pointer-events-auto ">
            <div class="flex justify-between items-center py-3 px-4 border-b">
                <h3 id="hs-scale-animation-modal-label" class="font-bold text-gray-800 text-xl">
                    Input Data
                </h3>
                <button type="button"
                ...
                <form action="/manajer/create" method="post">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="no_hp" inputmode="numeric" pattern="[0-9]*" placeholder="Masukkan Nomor Telepon"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 "
                    ...
                    <div class="mb-4">
                        ...
                        <input name="provinsi" placeholder="Ex: jawa Timur"
                            class="mt-1 block w-full border-gray-300 rounded-lg shadow-sm p-2.5" required>
                        @error('provinsi')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        @error('email')
                            <div class="text-danger text-red-700">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-6">
