<aside id="logo-sidebar"
    class="fixed top-0 left-0 z-40 w-64 h-screen -translate-x-full bg-yellow-400 md:translate-x-0 transition-all duration-500"
    aria-label="Sidebar">
    {{-- logo area --}}
    ...
    <div class="h-full px-3 pb-[290px] grid grid-cols-1 gap-4 overflow-y-auto p-4 bg-yellow-400 relative w-64 scrollbar">
        <ul class="space-y-2 font-medium">
            ...
            <h1 class="text-white font-bold text-lg">OTHERS</h1>
            <li>
                <a href="/admin" class="flex items-center p-2 text-white rounded-lg group hover:underline">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                        class="flex-shrink-0 w-5 h-5 fill-white  transition duration-75"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
        ...
        {{-- menu bawa --}}
        <div class="fixed w-64 bottom-0 bg-yellow-400 left-0 pt-2 px-3 pb-4 h-[195px]">
