<div class="mt-24">
    ...
    <div class="w-full mb-1">
        <div class="mb-1">
            ...
            <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl capitalize">data karyawan</h1>
        </div>
        <div class="md:flex">
            <div class="items-center mb-3 sm:flex sm:divide-x sm:divide-gray-100 sm:mb-0">
                ...
                <form action="{{ route('lamaran.index') }}" method="GET" class="mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            <label for="status" class="block text-sm font-medium text-gray-700">Posisi</label>
