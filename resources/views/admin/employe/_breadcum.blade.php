                ...
                <form class="lg:pr-3" action="#" method="GET">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 md:gap-x-4">
                        ...
                        <div class="flex gap-2">
                            <!-- Tombol Search -->
                            <button type="submit" class="border-2 bg-blue-700 rounded-lg">
                                <h1 class="py-2 px-3 text-white font-semibold">
                                    Search
                                </h1>
                            </button>

                            <!-- Tombol Undo -->
                            <button type="button" class="border-2 bg-red-700 rounded-lg">
                                <h1 class="py-2 px-3 text-white font-semibold">
                                    Undo
                                </h1>
                            </button>
