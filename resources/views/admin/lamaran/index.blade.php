                            ...
                            <td class="p-4">
                                <div class="flex justify-center gap-x-4 items-center">
                                    ...
                                    <form action="/delete/" method="POST">
                                        @csrf
                                        <button class="mr-4 mt-1" title="Delete" type="button" id="deleteButton"
                                        ...
                                        <div id="deleteModal" tabindex="-1" aria-hidden="true"
                                            ...
                                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                                ...
                                                <div class="relative p-4 text-center bg-white rounded-lg shadow  sm:p-5">
                                                    ...
                                                    <svg class="text-black w-11 h-11 mb-3.5 mx-auto" aria-hidden="true"
                                                    ...
                                                    <div class="flex justify-center items-center space-x-4">
                                                        <button data-modal-toggle="deleteModal" type="button"
                                                            class="py-2 px-3 text-sm font-medium text-black bg-white rounded-lg border border-gray-600 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 ">
                                                            tidak, batalkan
                                                        </button>
                                                        <button type="submit"
