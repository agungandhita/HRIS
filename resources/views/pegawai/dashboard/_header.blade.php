            ...
            <div class="flex flex-row  justify-between">
                <div class="flex gap-x-2">
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar"
                        ...
                        class="inline-flex items-center p-2 text-sm fill-white rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2  ">
                    ...
                    <h1 class="font-semibold text-Sidebar my-auto text-xl">Absensi</h1>
                </div>
