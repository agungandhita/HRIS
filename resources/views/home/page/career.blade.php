                ...
                <div
                    ...
                    <div class="p-5">
                        ...
                        <div class="flex gap-x-9 pt-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 md:w-6 fill-slate-600">
                                <path
                            ...
                            <p class="mt-1 text-sm text-gray-800 leading-relaxed md:text-lg capitalize">: {{ $item->level }} </p>
                        </div>
                        <div class="flex gap-x-9 pt-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 md:w-6 fill-slate-600">
                                <path
                            ...
                            <p class="mt-1 text-sm text-gray-800 leading-relaxed md:text-lg">: {{ \Carbon\Carbon::parse($item->tanggal)->translatedFormat('d F Y') }}</p>
                        </div>
                        <div class="flex gap-x-9 pt-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 md:w-6 fill-slate-600">
                                <path
