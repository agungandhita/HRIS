...
@section('container')
    <div class="before:z-10 object-contain before:absolute before:w-full before:h-full before:inset-0">
        ...
        <div
            ...
            <h2 class="text-yellow-400 stroke-2 text-2xl md:text-4xl font-bold stroke-slate-950 mb-6 capitalize">Karir Anda
                Dimulai Dari Sini
            </h2>
                ...
                <div class="md:grid md:grid-cols-2 ">
                    <div class="md:flex justify-between">
                        <div class="flex gap-x-4 mt-6">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-6 md:w-6 fill-slate-600">
                                <path
                                    d="M12 20.8995L16.9497 15.9497C19.6834 13.2161 19.6834 8.78392 16.9497 6.05025C14.2161 3.31658 9.78392 3.31658 7.05025 6.05025C4.31658 8.78392 4.31658 13.2161 7.05025 15.9497L12 20.8995ZM12 23.7279L5.63604 17.364C2.12132 13.8492 2.12132 8.15076 5.63604 4.63604C9.15076 1.12132 14.8492 1.12132 18.364 4.63604C21.8787 8.15076 21.8787 13.8492 18.364 17.364L12 23.7279ZM12 13C13.1046 13 14 12.1046 14 11C14 9.89543 13.1046 9 12 9C10.8954 9 10 9.89543 10 11C10 12.1046 10.8954 13 12 13ZM12 15C9.79086 15 8 13.2091 8 11C8 8.79086 9.79086 7 12 7C14.2091 7 16 8.79086 16 11C16 13.2091 14.2091 15 12 15Z">
                                </path>
                            </svg>
                            <p class="mt-2 text-base text-gray-800 leading-relaxed md:text-lg capitalize">: Lamongan</p>
                        </div>
                        ...
                        <div class="flex gap-x-4 mt-6">
                            ...
                            <p class="mt-2 text-base text-gray-800 leading-relaxed md:text-lg capitalize">: 12 Juni 2001
                            </p>
                        </div>
                        ...
                        <div class="flex gap-x-4 mt-6">
                            ...
                            <p class="mt-2 text-base text-gray-800 leading-relaxed md:text-lg capitalize">: Tetap </p>
                        </div>
                    ...
                    <div class="mt-4 flex justify-center items-center md:flex md:justify-end md:items-end">
                        <button type="button"
                            class="px-3 py-2 md:px-6 md:py-3 rounded-lg text-white text-sm md:text-xl tracking-wider font-semibold outline-none bg-orange-600 hover:bg-orange-700 border-2 border-orange-600 transition-all duration-300">Lamar Disini</button>
                    </div>
                </div>
            </div>
