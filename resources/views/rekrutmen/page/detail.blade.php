...
@section('container')
    <div class="before:z-10 object-contain before:absolute before:w-full before:h-full before:inset-0">
        ...
        <div
            ...
            <h2 class="text-yellow-400 stroke-2 text-2xl md:text-6xl font-bold font-[sans-serif] stroke-slate-950 mb-6 capitalize">Karir Anda
                Dimulai Dari Sini
            </h2>
        ...
        <div class="bg-white relative z-20 mx-auto w-full rounded-t-3xl min-h-[380px] pb-20">
                ...
                <div class="md:grid md:grid-cols-2 ">
                    <div class="md:flex justify-between">
                        <div class="flex gap-x-4 mt-6">
                            ...
                            <p class="mt-2 text-base text-gray-800 leading-relaxed md:text-2xl md:pt-2 capitalize font-[sans-serif]">: Lamongan</p>
                        </div>
                        ...
                        <div class="flex gap-x-4 mt-6">
                            ...
                            <p class="mt-2 text-base text-gray-800 leading-relaxed md:text-2xl md:pt-2 capitalize font-[sans-serif]">: 12 Juni 2001
                            </p>
                        </div>
                        ...
                        <div class="flex gap-x-4 mt-6">
                            ...
                            <p class="mt-2 text-base text-gray-800 leading-relaxed md:text-2xl md:pt-2 capitalize font-[sans-serif]">: Tetap </p>
                        </div>
            ...
            <div class="pl-6 md:px-12 py-10 flex flex-col md:flex-row border-b">
                <div class="w-full lg:w-8/12 mt-10 md:pr-10">
                    ...
                    <div class="prose" style="max-width: 100%">
                        <ul class="list-disc list-inside space-y-6 pl-4 ">
                            <li class="text-gray-600">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cupiditat
                            </li>
                            <li class="text-gray-600">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cupiditat
                            </li>
                            <li class="text-gray-600">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Cupiditat
                    ...
                    <div class="mt-10">
                        ...
                        <div class="prose" style="max-width: 100%">
                            <ul class="list-disc list-inside space-y-6 pl-4 ">
                                <li class="text-gray-600">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                                    Cupiditat</li>
                                <li class="text-gray-600">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
                                    Cupiditat</li>
                                <li class="text-gray-600">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
