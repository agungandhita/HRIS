...
@section('container')
    <div class="before:z-10 object-contain before:absolute before:w-full before:h-full before:inset-0">
        <img src="{{ asset('bahan/rekrut.png') }}" class="absolute inset-0 w-full h-full object-cover opacity-85" alt="Banner Image">
        <div
        ...
        <div class="bg-white relative z-20 mx-auto w-full rounded-t-2xl min-h-[380px] pb-20">
            ...
            <div class="md:flex md:flex-nowrap gap-x-4 px-7">
                <div
                    ...
                    <div class="p-5">
                        <h3 class="text-lg md:text-2xl font-semibold ">Supervisor Branch Lamongan Jawa Timur</h3>
                        <div class="flex gap-x-9 pt-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 fill-slate-600">
                                <path
                            ...
                            <p class="mt-1 text-sm text-gray-800 leading-relaxed md:text-sm">: staff </p>
                        </div>
                        <div class="flex gap-x-9 pt-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 fill-slate-600">
                                <path
                            ...
                            <p class="mt-1 text-sm text-gray-800 leading-relaxed md:text-sm">: Rabu 14 November 2024 </p>
                        </div>
                        <div class="flex gap-x-9 pt-3">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-5 fill-slate-600">
                                <path
                            ...
                            <p class="mt-1 text-sm text-gray-800 leading-relaxed md:text-sm">: Lamongan </p>
                        </div>
