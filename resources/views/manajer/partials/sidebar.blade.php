<aside id="logo-sidebar"
    ...
    <div class="h-20 mb-2 border-b-[1px] border-main2 px-3 relative">
        <div class="flex gap-x-4 absolute top-[50%] -translate-y-[50%] p-2">
            <h1 class="font-semibold text-white text-[21px] my-auto">Manajer</h1>
        </div>
    </div>
    <div class="h-full px-3 pb-[290px] grid grid-cols-1 gap-4 overflow-y-auto p-4 bg-Sidebar relative w-64 scrollbar">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="/manajer" class="flex items-center p-2 text-gray-400 rounded-lg group">
            ...
            <li>
                <a href="/list/pegawai" class="flex items-center p-2 text-gray-400 rounded-lg group">
                    ...
                    <span class="ml-3 font-semibold">Data Pegawai</span>
                </a>
            </li>
            {{-- <li>
                <a href="/admin" class="flex items-center p-2 text-gray-400 rounded-lg group">
                    ...
                    <span class="ml-3 font-semibold">Prog</span>
                </a>
            </li> --}}
            {{-- <li>
                <button type="button"
                    ...
                    <span class="flex-1 font-semibold ml-3 text-left whitespace-nowrap">E-commerce</span>
            ...
            <h1 class="text-gray-400 text-sm">Stock Resto</h1>
            <li>
            ...
            <li>
                <a href="/stock" class="flex items-center p-2 text-gray-400 rounded-lg group">
                    ...
                    <span class="ml-3 font-semibold">Stock Bahan</span>
                </a>
            </li>
            ...
            <li>
                <a href="/admin" class="flex items-center p-2 text-gray-400 rounded-lg group">
                    ...
                    <span class="ml-3 font-semibold">Input Stock</span>
                </a>
            </li>
            <h1 class="text-gray-400 text-sm">OTHERS</h1>
            <li>
                <a href="/admin" class="flex items-center p-2 text-gray-400 rounded-lg group">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                        class="flex-shrink-0 w-5 h-5 fill-gray-400 transition duration-75"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
